...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(import.meta.env.VITE_ADMIN_BACKEND_URL + import.meta.env.VITE_ADMIN_FORGOT_PASSWORD, {
            ...
            <div className="w-full max-w-md">
                <div className="bg-white rounded-xl border border-slate-200 p-8">
                    ...
                    <p className="text-center text-sm text-slate-500 mt-6">Remember your password?
                        <Link to="/" className="font-medium text-emerald-600 hover:text-emerald-700 ml-1">
                            Log In
                        </Link>
                    </p>
                </div>
