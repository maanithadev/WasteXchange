...
const SellerMyListings = () => {
    ...
    async function onsubmit(formData) {
        ...
        try {
            const response = await axios.put(import.meta.env.VITE_USERS_BACKEND_URL + import.meta.env.VITE_UPDATE_SELLER_WASTE_LISTING_URL + editData._id,
                saveFormData,
                {
                    headers: {
                        "Authorization": `Bearer ${localStorage.getItem("token")}`,
    ...
    const handleDeleteConfirm = async () => {
        try {
            await axios.delete(import.meta.env.VITE_USERS_BACKEND_URL + import.meta.env.VITE_DELETE_SELLER_WASTE_LISTING_URL + selectedItem._id, {
                headers: {
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
                }
            });
            ...
            <main className="flex-1 p-8 bg-slate-50 min-h-screen relative">
                ...
                {isEditModalOpen && editData && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                        <div
                            className="bg-white rounded-xl shadow-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto p-6 relative">
                ...
                {isDeleteModalOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                        <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-6 relative">
                            ...
                            <p className="text-slate-600 mb-6">Are you sure you want to delete this listing? This action
                                cannot be undone.</p>
