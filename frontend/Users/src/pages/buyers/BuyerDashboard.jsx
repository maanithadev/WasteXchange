            ...
            <main className="flex-1 p-8 bg-slate-50 min-h-screen">
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">Welcome back, EcoPlast Industries</p>
                    </div>
                    <Link to="/buyer/browse-marketplace">
                        <button
                            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm px-4 py-2.5 rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                    <div className="bg-white rounded-xl border border-slate-200 p-5">
                        <div className="flex items-center justify-between mb-3">
                            <span className="text-sm font-medium text-slate-500">Matched Listings</span>
                        ...
                        <p className="text-3xl font-bold text-slate-900">{card.matchedListings || 0}</p>
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 p-5">
                        ...
                        <p className="text-3xl font-bold text-slate-900">{card.activeOrders || 0}</p>
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 p-5">
                        ...
                        <p className="text-3xl font-bold text-slate-900">{card.unreadNotifications || 0}</p>
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 p-5">
                        ...
                        <p className="text-3xl font-bold text-slate-900">{card.currentMonthCarbonSaved || 0}t</p>
                        <p className="text-xs text-slate-400 mt-1">Carbon Saved from purchases</p>
                    </div>
                </div>
