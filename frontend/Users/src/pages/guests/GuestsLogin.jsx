                        ...
                        <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
                            <div>
                                ...
                                <input type="email"
                                    ...
                                    className="w-full rounded-lg border border-slate-300 px-4 py-2.5 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-500" required />
