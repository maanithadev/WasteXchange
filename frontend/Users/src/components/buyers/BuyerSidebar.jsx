            ...
            <div className="flex">
                ...
                <aside className="w-64 h-screen bg-white border-r border-slate-200 flex flex-col shrink-0">
                    <div className="h-16 flex items-center px-6 border-b border-slate-200">
                        <span className="text-xl font-bold text-blue-700">WasteXchange</span>
                    </div>

                    <nav className="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                        <Link to="/buyer/dashboard"
                              className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-blue-50 text-blue-700 font-medium text-sm">
                    ...
                    <div className="border-t border-slate-200 p-3">
                        <button to="#" onClick={logOut}
                                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-600 hover:bg-red-50 hover:text-red-600 font-medium text-sm">
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
