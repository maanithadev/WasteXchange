            ...
            <main class="flex-1 p-8 bg-slate-50 min-h-screen">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p class="text-sm text-slate-500 mt-1">Welcome back, Green Metals Co.</p>
                    </div>
                    <button class="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white font-medium text-sm px-4 py-2.5 rounded-lg">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                    <div class="bg-white rounded-xl border border-slate-200 p-5">
                        <div class="flex items-center justify-between mb-3">
                            <span class="text-sm font-medium text-slate-500">Active Listings</span>
                        ...
                        <p class="text-xs text-slate-400 mt-1">+2 this week</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 p-5">
                        ...
                        <p class="text-3xl font-bold text-slate-900">4.2t</p>
                        <p class="text-xs text-slate-400 mt-1">CO2e this year</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-6">
                    ...
                    <ul class="divide-y divide-slate-100">
                        <li class="flex items-start gap-4 py-4">
                            ...
                            <div class="flex-1">
                                <p class="text-sm text-slate-800"><span class="font-medium">EcoPlast Industries</span> confirmed an order for Shredded HDPE Pellets</p>
                        ...
                        <li class="flex items-start gap-4 py-4">
                            ...
                            <div class="flex-1">
                                <p class="text-sm text-slate-800">New message from <span class="font-medium">Circular Metals Ltd.</span> about Scrap Aluminum Sheets</p>
                        ...
                        <li class="flex items-start gap-4 py-4">
                            ...
                            <div class="flex-1">
                                <p class="text-sm text-slate-800">Your listing <span class="font-medium">Wood Offcuts – Grade A</span> went live</p>
                        ...
                        <li class="flex items-start gap-4 py-4">
                            <div class="w-9 h-9 rounded-full bg-teal-100 flex items-center justify-center shrink-0">
                                <svg class="w-5 h-5 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a4 4 0 00-8 0v2m-2 0h12a2 2 0 012 2v7a2 2 0 01-2 2H7a2 2 0 01-2-2v-7a2 2 0 012-2z" /></svg>
                            </div>
                            <div class="flex-1">
                                <p class="text-sm text-slate-800">Payout of <span class="font-medium">$1,240.00</span> was deposited</p>
