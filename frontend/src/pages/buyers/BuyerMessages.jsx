                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-4 overflow-y-auto">
                        <div className="flex justify-start">
                            <div
                                ...
                                <p class="text-sm text-slate-800">Hi! Is the Shredded HDPE Pellets listing still
                                    available?</p>
                        ...
                        <div className="flex justify-end">
                            <div className="max-w-xs bg-blue-600 rounded-2xl rounded-br-sm px-4 py-2.5">
                                <p class="text-sm text-white">Around 98% purity, minimal contamination. I can send
                                    photos.</p>
