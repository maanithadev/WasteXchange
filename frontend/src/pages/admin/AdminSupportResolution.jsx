                        ...
                        <table class="w-full text-sm">
                            <thead>
                                <tr class="bg-slate-50 border-b border-slate-200">
                                    <th class="text-left font-semibold text-slate-500 px-6 py-3 text-xs uppercase tracking-wide">Ticket ID</th>
                                    <th class="text-left font-semibold text-slate-500 px-6 py-3 text-xs uppercase tracking-wide">Submitted By</th>
                            ...
                            <tbody class="divide-y divide-slate-100">
                                <tr>
                                    ...
                                    <td class="px-6 py-3.5"><span class="text-xs font-semibold bg-red-100 text-red-700 px-2 py-0.5 rounded-full">High</span></td>
                                    <td class="px-6 py-3.5"><span class="text-xs font-semibold bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full">Open</span></td>
                                    <td class="px-6 py-3.5 text-slate-500">Jul 8, 2026</td>
                                    <td class="px-6 py-3.5 text-right"><button class="text-xs font-medium bg-indigo-600 text-white rounded-md px-2.5 py-1 hover:bg-indigo-700">Respond</button></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="px-6 py-3.5"><span class="text-xs font-semibold bg-red-100 text-red-700 px-2 py-0.5 rounded-full">High</span></td>
                                    <td class="px-6 py-3.5"><span class="text-xs font-semibold bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full">In Progress</span></td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3.5"><span class="text-xs font-semibold bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full">Medium</span></td>
                                    <td class="px-6 py-3.5"><span class="text-xs font-semibold bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full">Open</span></td>
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-3.5"><span class="text-xs font-semibold bg-slate-100 text-slate-500 px-2 py-0.5 rounded-full">Low</span></td>
                                    <td class="px-6 py-3.5"><span class="text-xs font-semibold bg-emerald-100 text-emerald-700 px-2 py-0.5 rounded-full">Resolved</span></td>
                                    <td class="px-6 py-3.5 text-slate-500">Jul 2, 2026</td>
                                    <td class="px-6 py-3.5 text-right"><button class="text-xs font-medium border border-slate-300 text-slate-600 rounded-md px-2.5 py-1 hover:bg-slate-50">View</button></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
